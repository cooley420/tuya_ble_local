"""The Tuya BLE Local integration."""
...
from ._ble import TuyaBLEDataPointType, TuyaBLEDevice
...
mapping: dict[str, TuyaBLECategorySelectMapping] = {
    ...
    "szjqr": TuyaBLECategorySelectMapping(
        products={
            "3yqdo5yt": [TuyaBLEFingerbotModeMapping(dp_id=2)],
            "xhf790if": [TuyaBLEFingerbotModeMapping(dp_id=2)],
            "blliqpsj": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "ndvkgsrm": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "yiihr7zh": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "neq16kgd": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "ltak7e1p": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "y6kttvd6": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "yrnk7mnn": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "nvr2rocq": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "bnt7wajf": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "rvdceqjh": [TuyaBLEFingerbotModeMapping(dp_id=8)],
            "5xhbk964": [TuyaBLEFingerbotModeMapping(dp_id=8)],
        },
    ),
...
def get_mapping_by_device(device: TuyaBLEDevice) -> list[TuyaBLESelectMapping]:
    ...
    if category.products:
        ...
        _LOGGER.debug(
            "No select mapping found for product_id: %s (category: %s)",
            device.product_id,
            device.category,
        )
...
async def async_setup_entry(
    ...
    """Set up the Tuya BLE select entities."""
